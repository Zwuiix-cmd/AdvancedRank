...
class RankSubUserRemovePermission extends RankSubCommand
{
    public function __construct()
    {
        parent::__construct("removeuserpermission", "Remove a permission in a user", []);
    }
    ...
    public function onNormalRun(Player $sender, string $aliasUsed, array $args): void
    {
        ...
        $user->removePermission($args["permission"]);
